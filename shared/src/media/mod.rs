...
pub trait StorageBackend: Send + Sync {
    ...
    async fn get_segment(&self, room_id: Uuid, segment_id: &str) -> Result<Vec<u8>, std::io::Error>;
    async fn list_segments(&self, room_id: Uuid) -> Result<Vec<String>, std::io::Error>;
}
